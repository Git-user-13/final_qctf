"""
Django settings for ctf_website project.
...
MIDDLEWARE = [
    ...
    'app1.middleware.DisableCacheMiddleware',
]

ROOT_URLCONF = 'ctf_website.urls'
...
WSGI_APPLICATION = 'ctf_website.wsgi.application'
